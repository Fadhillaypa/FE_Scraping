    ...
    return (
        <div  className="about-container">
            <div className="about-card">
                ...
                <p className="about-text">
                At Scrape Now, we are committed to providing cutting-edge technology that empowers your business with the data you need. Join thousands of users who trust us to scrape the web for actionable insights.
                </p>
                <p className="about-text">
